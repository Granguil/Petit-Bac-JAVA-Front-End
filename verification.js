...
function verification(str){
            ...
            if(bool){
                ...
                $.ajax({type:"post",
                url:"http://localhost:5000/score/maj",
                data:data,
                })
                let data2=JSON.stringify({categorieBean:{categorie:theme},mot:mot});
                $.ajax({
                    type:"post",
                    url:"http://localhost:5000/Mot/add",
                    data:data2,
    ...
    if(bool){
        ...
        let data=JSON.stringify({pseudo:pseudo,score:score,nb_partie:nbp,en_attente:ea});
        $.ajax({type:"post",
        url:"http://localhost:5000/score/maj",
        data:data,
        contentType: "application/json;charset=utf-8",
